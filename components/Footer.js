  ...
  return (
    <footer className='border-t-[1px] border-white mt-3'>
        <ul className='flex justify-center my-3 '>
            ...
            <a href="https://twitter.com/Ahmad365Raza" target="_blank" rel='noreferrer'> <FaTwitter className='text-4xl md:text-6xl mx-2 text-white hover:text-light-primary cursor-pointer transition-all duration-300 ease-in' /> </a>
